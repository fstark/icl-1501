...
cpu_t &emulator_t::cpu() { return cpu_; }
io_t &emulator_t::io() { return io_; }
memory_t &emulator_t::memory() { return memory_; }
crt_t::screen_buffer_t &emulator_t::screen() { return screen_; }
