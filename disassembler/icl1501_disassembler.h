...
private:
    ...
    bool decodeSAC(int addr, int offset, ICL1501Formatter &formatter);
    bool decodeLSW(int addr, int offset, ICL1501Formatter &formatter);
    bool decodeLPS(int addr, int offset, ICL1501Formatter &formatter);
